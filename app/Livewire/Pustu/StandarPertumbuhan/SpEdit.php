...
class SpEdit extends Component
{
    public $standar;
    ...
    {
        $this->standar = StandarPertumbuhan::findOrFail($id);
        $this->fill($this->standar->toArray());
    }
    ...
    {
        return view('livewire.pustu.standar-pertumbuhan.sp-edit');
    }
}
