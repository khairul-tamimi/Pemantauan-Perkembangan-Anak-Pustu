...
class PemeriksaanCreate extends Component
{
    ...
    public function save()
    {
        ...
        JadwalKunjungan::where('anak_id', $this->anak_id)
            ->where('tanggal_kunjungan', $this->tanggal)
            ->update(['status' => 'Hadir']);
    ...
    {
        return view('livewire.pustu.pemeriksaan.pemeriksaan-create', [
